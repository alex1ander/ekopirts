<div class="share-buttons">
    ...
    <span class="share-text"><?php _e('Share','ekopirts') ?>:</span>
...
<script>
        ...
        const pageTitle = document.title || 'Посмотри эту страницу!';
        ...
        function shareInstagram() {
            alert('Instagram не поддерживает прямую публикацию через веб.\n\nВы можете:\n1. Скопировать ссылку и вставить в Stories\n2. Использовать мобильное приложение Instagram\n3. Создать пост вручную с этой ссылкой');
